"""
Django settings for late_glitter_2 project.
...
ROOT_URLCONF = 'late_glitter_2.urls'
...
WSGI_APPLICATION = 'late_glitter_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_glitter_2 API",
    "DESCRIPTION": "API documentation for late_glitter_2 App",
    "VERSION": "v1",
}
